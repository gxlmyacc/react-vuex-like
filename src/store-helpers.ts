 ...
 * @param {Object}
 */
export const mapState = normalizeNamespace((namespace: string, states: Partial<any> | any[]) => {
 ...
 * @return {Object}
 */
export const mapMutations = normalizeNamespace((namespace: string, mutations: Partial<any> | any[]) => {
  const res: Partial<any> = {};
 ...
 * @return {Object}
 */
export const mapGetters = normalizeNamespace((namespace: string, getters: Partial<any> | any[]) => {
  const res: Partial<any> = {};
 ...
 * @return {Object}
 */
export const mapActions = normalizeNamespace((namespace: string, actions: Partial<any> | any[]) => {
  const res: Partial<any> = {};
 ...
 * @return {Object}
 */
function normalizeMap(map: Partial<any> | any[]) {
 ...
 * @return {Function}
 */
function normalizeNamespace(fn: (namespace: string, map: Partial<any> | any[]) => any) {
  return (namespace: string, map: Partial<any> | any[]) => {
 ...
 * @return {Object}
 */
function getModuleByNamespace(store: any, helper: any, namespace: string) {
